...
if __name__ == '__main__':
    ...
    English_columns=["Province","County","Povy","MeanNTL","Slope","RoadDensity","RailwayDensity","PopuDensity","ConstructionLand","EducationYear","ImmigrantPopu","PerHousing","NonAgriculturalPopu","Istrain"]
